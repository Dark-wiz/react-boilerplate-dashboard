            ...
            <div>
                <div className="page-header row no-gutters py-4">
                    {/* <div className="col-12 col-sm-4 text-center text-sm-left mb-0">
                        <h3 className="page-title">Register Vehicle</h3>
                    </div> */}
                </div>
                <div className="row">
                                            ...
                                            <form>
                                                <div className="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <textarea class="form-control" name="details" rows="5" placeholder="Enter vehicle details">{details}</textarea>
                                                    </div>
                                                </div>


                                                <button type="submit" className="btn btn-accent">Add Vehicle</button>
                                            </form>
                                        </div>
                                    </div>
                                </li>
